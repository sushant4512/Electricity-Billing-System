...
public class project extends JFrame implements ActionListener{
    ...
    project(String atype, String meter) {
        ...
        master.setFont(new Font("Raieway", Font.PLAIN, 20));
        ...
        info.setFont(new Font("Raieway", Font.PLAIN, 20));
        ...
        user.setFont(new Font("Raieway", Font.PLAIN, 20));
        ...
        report.setFont(new Font("Raieway", Font.PLAIN, 20));
        ...
        utility.setFont(new Font("Raieway", Font.PLAIN, 20));
       ...
       mexit.setFont(new Font("Raieway", Font.PLAIN, 20));
